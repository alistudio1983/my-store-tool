...
# هذا القالب مخزن هنا بشكل محمي، مستحيل أن ينكسر أو يعطي شاشة بيضاء
# ==========================================================
MASTER_TEMPLATE = """
<!DOCTYPE html>
...
def generate_landing_page_json(api_key, product):
    # استخدام بروتوكول REST لمنع تعليق الاتصال، ومهلة 20 ثانية فقط
    ...
    # حيلة برمجية لتنظيف النص بدون استخدام علامات الماركداون التي تقطع الملف
    tb = chr(96) * 3  # يولد علامات التنصيص الثلاثية بشكل آمن
    ...
    if not api_key or not product_name:
        ...
        with st.spinner("1️⃣ جاري توليد المحتوى التسويقي..."):
            try:
                ...
                st.error("⚠️ حدث خطأ في قراءة استجابة الذكاء الاصطناعي. حاول مرة أخرى.")
